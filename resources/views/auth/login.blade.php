                            ...
                            @csrf
                                ...
                                <div class="form-group py-1 pb-2">
                                    <div class="input-field">
                                         ...
                                         <input type="password" placeholder="Parol" name="password" required> <button class="btn bg-white text-muted">
                                ...
                                <div class="form-inline">
                                    ...
                                    <a href="#" id="forgot" class="font-weight-bold">Parolni unitdingizmi?</a>
                                </div>
                                <button type="submit" class="btn btn-primary btn-block mt-3">Kirish</button>
                                <div class="text-center pt-4 text-muted">
                                    Saytda xisobingiz yo'qmi?
